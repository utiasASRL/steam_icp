...
auto ElasticOdometry::registerFrame(const DataFrame &const_frame) -> RegistrationSummary {
...
void ElasticOdometry::initializeTimestamp(int index_frame, const DataFrame &const_frame) {
